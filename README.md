...
This plugin for [Obsidian](https://obsidian.md) allows you to import YouTube video metadata into your Obsidian notes. It now also supports integration with TubeArchivist.

## Usage

Use the command "Create new YouTube note" to open the search window, where you can enter the YouTube URL, Video ID, or TubeArchivist URL. The plugin will then create a note from the configured template and replace variables in the template with video metadata from the YouTube API or TubeArchivist.
